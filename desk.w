...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:16px;left:408px;"/> 
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="menu.w" routable="true" forceRefreshOnOpen="true"></span><div xid="div2" style="background-color:#f5f5f5;" class="x-full"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="花田最鲜货火锅">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row15" bind-click="row15Click">
    ...
    <div class="x-col x-col-fixed x-col-center" xid="col39" style="width:auto;">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label=" 大厅" xid="button19" icon="icon-chevron-right" style="padding-left:10px;color:#800000;">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row17">
    ...
    <div class="x-col x-col-fixed x-col-center" xid="col38" style="width:auto;">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label=" 大厅" xid="button16" icon="icon-chevron-right" style="padding-left:10px;color:#008080;">
      <i xid="i20" class="icon-chevron-right"></i>
      <span xid="span35" style="font-weight:bold;">大厅</span></a> </div> </div> </li><div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list4" autoLoad="true">
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row14">
    ...
    <div class="x-col x-col-fixed x-col-center" xid="col40" style="width:auto;">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label=" 大厅" xid="button18" icon="icon-chevron-right" style="padding-left:10px;color:#FF6600;">
